...
- Alias runtime file: `prompts/aliases/dcg-product.txt`
- Original file: `prompts/test/product_oriented_ad_image_prompt.definition-control-genprompt.txt`
...
Part 1: Product-specific prompt generated from the confirmed definition-only Product-oriented condition
