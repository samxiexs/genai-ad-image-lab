...
- Role: `stage-2 visual-control wrapper`
- Alias runtime file: `prompts/aliases/dcg-experiential.txt`
- Original file: `prompts/test/experiential_oriented_ad_image_prompt.definition-control-genprompt.txt`
...
Part 1: Product-specific prompt generated from the confirmed definition-only Experiential-oriented condition
