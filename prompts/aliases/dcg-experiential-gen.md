# dcg / experiential / gen

- Condition: `definition-control-genprompt`
- Role: `stage-1 generator prompt`
- Alias runtime file: `prompts/aliases/dcg-experiential-gen.txt`
- Original file: `prompts/test/experiential_oriented_ad_image_prompt_generator.definition-control-genprompt.txt`

## PromptYou will convert the following definition-only Experiential-oriented advertising prompt into one final image-generation prompt for the exact source product.
