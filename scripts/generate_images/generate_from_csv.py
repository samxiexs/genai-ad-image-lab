...
def research_conditions_v12_path(orientation: str, filename: str) -> str:
    return f"{RESEARCH_CONDITIONS_V12_DIR}/{RESEARCH_CONDITIONS_V4_ORIENTATION_DIRS[orientation]}/{filename}"
...
DEFAULT_BASE_PROMPT_FILES = {
    ...
    "definition-genprompt-v7": {
        orientation: research_conditions_v7_path(orientation, "generator.definition-genprompt.txt")
        for orientation in RESEARCH_CONDITIONS_V4_ORIENTATION_DIRS
    },
    "definition-control-genprompt-v7": {
...
PROMPT_VERSION_FILES = {
    ...
    "definition-only-v7": {
        orientation: research_conditions_v7_path(orientation, "definition-only.txt")
        for orientation in RESEARCH_CONDITIONS_V4_ORIENTATION_DIRS
    },
    "definition-control-v7": {
        orientation: research_conditions_v7_path(orientation, "definition-control.txt")
        for orientation in RESEARCH_CONDITIONS_V4_ORIENTATION_DIRS
    },
    "visual-control-v7": {
        orientation: research_conditions_v7_path(orientation, "definition-control.txt")
    ...
    "definition-genprompt-v7": {
        orientation: research_conditions_v7_path(orientation, "definition-genprompt.txt")
        for orientation in RESEARCH_CONDITIONS_V4_ORIENTATION_DIRS
    },
    "definition-control-genprompt-v7": {
    ...
    "definition-only-v12": {
        orientation: research_conditions_v12_path(orientation, "definition-only.txt")
        for orientation in RESEARCH_CONDITIONS_V4_ORIENTATION_DIRS
    },
}
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "definition-only-v9/definition-only-v10/definition-only-v11/definition-only-v12, "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "and definition-only-v12 copies the v11 definition-only prompt set in prompts/research_conditions_v12."
        ),
    )
    parser.add_argument(
        "--run-dir",
